/**
 * Centralização de Assets de Imagens
 * 
 * Para substituir clique no link ou, se estiver usando arquivos locais no futuro (GitHub):
 * 1. Coloque a imagem na pasta /public/images/
 * 2. Mude o link para "/images/seu-arquivo.jpg"
 */
